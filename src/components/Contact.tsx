  ...
  return (
    <section id="contact" className="section-padding bg-background">
      <div className="container mx-auto max-w-4xl text-center">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 slide-up">
          <a 
            href="mailto:er.rimansingh@gmail.com"
            className="bg-card p-8 rounded-2xl shadow-soft hover:shadow-medium transition-all duration-300 border border-border/50 group"
          >
            ...
            <p className="text-muted-foreground text-sm">er.rimansingh@gmail.com</p>
          </a>
